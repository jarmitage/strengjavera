...
class OSCWrapper:
    def __init__(self, host_ip, client_ip, receive_port, send_port, name, create_patch=True, patch_type="Pd", verbose=True, concurrent=True):
        ...
        self.host = OSC(self.host_ip, self.receive_port, verbose=verbose, concurrent=verbose)
